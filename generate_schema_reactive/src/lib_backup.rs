...
use serde_types::constraint_schema_item::ConstraintSchemaItem;
...
fn get_variant_builder_name(element: &Box<&dyn ConstraintSchemaItem<TTypes = PrimitiveTypes, TValues = PrimitiveValues>> ) -> syn::Ident {
...
pub fn generate_concrete_schema(input: TokenStream) -> TokenStream {
    ...
    let generate_trait_impl_streams = |instantiable: Box::<&dyn ConstraintSchemaItem<TTypes = PrimitiveTypes, TValues = PrimitiveValues>>| -> proc_macro2::TokenStream {
                    ...
                    match path_item {
                        serde_types::constraint_schema::TraitMethodImplPath::Field  (field_id) => {
                            match last_item_type {
                                serde_types::constraint_schema::ConstraintSchemaItemType::Template => {
                                ...
                                serde_types::constraint_schema::ConstraintSchemaItemType::Instance => {
                                ...
                                serde_types::constraint_schema::ConstraintSchemaItemType::Operative => {
                        ...
                        serde_types::constraint_schema::TraitMethodImplPath::InstanceConstituent(instance_constituent_id)=> {
                            ...
                            last_item_type =  serde_types::constraint_schema::ConstraintSchemaItemType::Instance;
                        }
                        serde_types::constraint_schema::TraitMethodImplPath::LibraryOperativeConstituent(library_operative_constituent_id) => {
                            ...
                            last_item_type =  serde_types::constraint_schema::ConstraintSchemaItemType::Operative;
                        }
                        _ => {}
                    };
    ...
    let mut generate_objects_streams = |instantiable: Box::<&dyn ConstraintSchemaItem<TTypes = PrimitiveTypes, TValues = PrimitiveValues>>| -> proc_macro2::TokenStream {
