...
pub fn FunctionDefinitionEditor(fn_def: RGSOConcrete<FunctionDefinition, Schema>) -> impl IntoView {
    ...
    let on_click_add_input = move |_| {
        match input_select_value.get() {
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOSingleOperative => {
                if let Some(op) = input_selected_operative.get() {
                    fn_def_clone
                        ...
                        .add_new_inputs::<FunctionIOSingleOperative, _>(|new| {
            ...
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOCollectionPrimitiveBool => todo!(),
            ...
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOTraitOperative => todo!(),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOCollectionSingleOperative => {
                todo!()
            }
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOMultiOperative => todo!(),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOCollectionPrimitiveInt => todo!(),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOSelf => todo!(),
        };
        ...
        match output_select_value.get() {
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOSingleOperative => {
                if let Some(op) = output_selected_operative.get() {
                    fn_def_clone
                        .edit(ctx_clone.clone())
                        .add_new_outputs::<FunctionIOSingleOperative, _>(|new| {
                    ...
                    <For
                        ...
                        children=move |input| {
                            ...
                            let on_click_delete = move |_| {
                                ...
                                match input {
                                    GetNameFunctionIOTraitObject::FunctionIOSingleOperative(
                                        item,
                                    ) => item.edit(ctx_clone.clone()).delete().execute().unwrap(),
                                    GetNameFunctionIOTraitObject::FunctionIOPrimitiveBool(item) => {
                                        item.edit(ctx_clone.clone()).delete().execute().unwrap()
                                    }
                                    GetNameFunctionIOTraitObject::FunctionIOPrimitiveInt(item) => {
                                        item.edit(ctx_clone.clone()).delete().execute().unwrap()
                                    }
                                    GetNameFunctionIOTraitObject::FunctionIOPrimitiveString(
                                        item,
                                    ) => item.edit(ctx_clone.clone()).delete().execute().unwrap(),
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionPrimitiveBool(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionMultiOperative(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionTraitOperative(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionPrimitiveString(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOTraitOperative(_) => {
                                        todo!()
                                    }
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionSingleOperative(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOMultiOperative(_) => {
                                        todo!()
                                    }
                                    GetNameFunctionIOTraitObject::FunctionIOCollectionPrimitiveInt(
                                        _,
                                    ) => todo!(),
                                    GetNameFunctionIOTraitObject::FunctionIOSelf(_) => todo!(),
                                };
                            };
...
fn DetailSelectionView(
    ...
    move || {
        ...
        match selected_variant.get() {
            ...
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOPrimitiveBool => EitherOf3::B(()),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOPrimitiveInt => EitherOf3::B(()),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOPrimitiveString => {
                EitherOf3::B(())
            }
            ...
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOTraitOperative => EitherOf3::B(()),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOSelf => EitherOf3::B(()),
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOCollectionSingleOperative => {
                EitherOf3::B(())
            }
            GetNameFunctionIOTraitObjectDiscriminants::FunctionIOMultiOperative => EitherOf3::B(()),
